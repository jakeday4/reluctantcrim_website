...
description-meta: "Two sets of assignments for a senior-level replication and reproducibility that was revised from our graduate-level course. First, are 'R Assignments' intended to provide a basic introduction to conducting reproducible research using the R Statistical Computing Environment and RStudio. Second, is a 'Reproducibility' Project' where students reproduce or conceptually replicate results reported in a published article using at least one of the first seven waves of the the National Youth Survey data"
---
