...
description-meta: "Two sets of assignments for our graduate level replication and reproducibility coure. First, are 'R Assignments' intended to provide a basic introduction to conducting reproducible research using the R Statistical Computing Environment and RStudio. Second, is a 'Reproducibility' Project' where students reproduce the (descriptive) results of a published article on a topic of interest to them."
---
...
::: {.column width="60%"}
### [Assignment 3: Introduction to R Markdown](r-assignments/R_Assign3_ICPSR_ReprodFig_Brauer.html)
