...
description-meta: "Two sets of assignments for our graduate level replication and reproducibility course. First, are 'R Assignments' intended to provide a basic introduction to conducting reproducible research using the R Statistical Computing Environment and RStudio. Second, is a 'Reproducibility' Project' where students reproduce some descriptive results reported in a published article on a topic of interest to them."
---
