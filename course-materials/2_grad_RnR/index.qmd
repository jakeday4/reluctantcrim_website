...
description: "Assignments for graduate level *replication and reproducibility* course. Includes a crash course for conducting reproducible research using R (#1-#4) and a 'reproducibility project' (#5-#8) where students reproduce or conceptually replicate results from a published article in their area of interest."
