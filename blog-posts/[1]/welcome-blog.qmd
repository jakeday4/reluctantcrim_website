...
Of course, this begs the question: Why have we been re-tooling our approaches to science? Well, answering that question requires a longer conversation with multiple threads, and we anticipate weaving some of those threads into our future blog posts. For now, it may be clear from our posted materials that we are motivated to act in response to increasing concerns about replication failures across multiple scientific disciplines and awareness of subsequent reforms. We are also motivated by our perception that our academic disciplines of sociology and criminology are lagging behind other fields in such self-reflecting on potential issues and adopting important reforms. Relatedly, we are moved by own experiences with reproducing [high-profile work](https://journals.sagepub.com/doi/10.1177/0049124119826158) and with attempting to address such important issues related to low statistical power and misinterpretations of null findings from null hypothesis significance tests through the traditional academic peer-review publication process. 
...
Of course, we are not alone - [scholars raise similar concerns in other social scientific disciplines](https://elevanth.org/blog/2022/09/19/the-problem-with-cultural-evolution/). Likewise, we benefit immensely from the contributions in blogs and bookdown projects shared freely for the collective good by so many people from numerous specializations within and outside academia. Our hope is that we will be able to similarly enrich conversations in our fields about how we might collectively strengthen our science through concerted efforts to improve our theories and the methods we use to generate knowledge about them. 
