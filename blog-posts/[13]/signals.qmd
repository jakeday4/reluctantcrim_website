...
Now, you should know that the authors did not invent the concept of an arrest rate signal nor its measurement as a ratio of experienced punishments (arrests) to punishable behaviors (self-reported offenses). Rather, their paper is the most recent in a line of studies investigating cognitive "Bayesian updating" of risk and reward perceptions (e.g., [Matsueda et al. 2006](https://journals.sagepub.com/doi/abs/10.1177/000312240607100105); [Anwar & Loughran 2011](https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1745-9125.2011.00233.x)). I pointed this out in my review: 
